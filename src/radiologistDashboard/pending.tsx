...
import dermPic from '../images/cov.png'
import dermLimePic from '../images/covSaliency.png'
...
export default function Pending() {
  ...
  const fetchAll = () => {
    fetch('http://localhost:5000/report/?dataset=rad')
  ...
  const handleResolve = () => {
    ...
    fetch(`http://localhost:5000/report/rad?cust_evaluated=${true}&cust_diagnosis=${report?.cust_diagnosis}&cust_concern=${report?.cust_concern}&cust_inspection=${report?.cust_inspection}&name=${report?.user_name}&request_id=${report?.id}&user_id=${report?.user_id}&cust_description=${report?.cust_description}`, requestOptions)
      .then(response => response.json())
      .then(data => {
        console.log(data)
      })
                  ...
                  <DialogContent dividers={scroll === 'paper'}>
                    ...
                    >
                      <Stack direction={"column"} spacing={3}>
                        ...
                        <Divider style={{padding: '8px'}}/>
                        <Stack direction={'row'} spacing={4} p={'8px'}>
                        <TextField
                          id="outlined-multiline-flexible"
